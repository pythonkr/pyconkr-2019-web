...
// ====================================================
// GraphQL query operation: getSprintProducts
// ====================================================

export interface getSprintProducts_sprintProducts_owner_profile {
...
export interface getSprintProducts_sprintProducts_owner {
  __typename: "UserNode";
  /**
  ...
  username: string;
  email: string;
  profile: getSprintProducts_sprintProducts_owner_profile | null;
}

export interface getSprintProducts_sprintProducts_sprintSet {
...
export interface getSprintProducts_sprintProducts {
   ...
   */
  total: number;
  owner: getSprintProducts_sprintProducts_owner | null;
  price: number;
  /**
  ...
  createdAt: any;
  updatedAt: any;
  sprintSet: (getSprintProducts_sprintProducts_sprintSet | null)[] | null;
  /**
...
export interface getSprintProducts {
  sprintProducts: (getSprintProducts_sprintProducts | null)[] | null;
}

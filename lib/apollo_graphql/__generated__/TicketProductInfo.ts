...
// ====================================================
// GraphQL fragment: TicketProductInfo
// ====================================================
...
export interface TicketProductInfo_owner {
  __typename: "UserNode";
  profile: TicketProductInfo_owner_profile | null;
}

export interface TicketProductInfo {
  ...
  owner: TicketProductInfo_owner | null;
  price: number;
  /**

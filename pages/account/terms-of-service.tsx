...
export default class ProposingATalk extends React.Component {
  render() {
    return (
      <PageTemplate
        header={<Header title='이용 약관 :: 파이콘 한국 2019' />}
        footer={<Footer />}
      >
        ...
        <Section>
          <H2>0. <IntlText intlKey='common.schedule'>목적</IntlText></H2>
        ...
        <Section>
          <H2>1. <IntlText intlKey='common.schedule'>약관의 동의와 변경</IntlText></H2>
          <Ol>
            <Li><IntlText intlKey='common.schedule'>
        ...
        <Section>
          <H2>2. <IntlText intlKey='common.schedule'>계약의 성립</IntlText></H2>
          <Paragraph><IntlText intlKey='asdfasdfasdf'>
            이용자가 회원가입을 통해 본 서비스의 회원이 될 경우 본 약관 및 관련 운영 정책을 동의하신 것으로 보고 약관이 체결됩니다.
          </IntlText></Paragraph>
          <Ol>
            <Li>
              <IntlText intlKey='common.schedule'>
        ...
        <Section>
          <H2>3. <IntlText intlKey='common.schedule'>개인정보 보호</IntlText></H2>
          <Paragraph><IntlText intlKey='asdfasdfasdf'>
        ...
        <Section>
          <H2>4. <IntlText intlKey='common.schedule'>서비스의 중단</IntlText></H2>
          <Ol>
            <Li><IntlText intlKey='common.schedule'>
        ...
        <Section>
          <H2>5. <IntlText intlKey='common.schedule'>회원 탈퇴 및 자격 상실</IntlText></H2>
          <Ol>
            <Li><IntlText intlKey='common.schedule'>
        ...
        <Section>
          <H2>6. <IntlText intlKey='common.schedule'>환급</IntlText></H2>
          <Paragraph><IntlText intlKey='asdfasdfasdf'>
        ...
        <Section>
          <H2>7. <IntlText intlKey='common.schedule'>이용자의 의무와 책임</IntlText></H2>
          <Ol>
            <Li><IntlText intlKey='common.schedule'>
        ...
        <Section>
          <H2>8. <IntlText intlKey='common.schedule'>저작물의 이용</IntlText></H2>
          <Ol>
            <Li><IntlText intlKey='common.schedule'>
        ...
        <Section>
          <H2>9. <IntlText intlKey='common.schedule'>분쟁의 해결</IntlText></H2>
          <Ol>
            <Li><IntlText intlKey='common.schedule'>

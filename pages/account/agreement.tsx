  ...
  render() {
    ...
    return (
      <PageTemplate
        ...
        footer={<Footer />}
      >
        <H1><IntlText intlKey='homeTitle'>약관 동의</IntlText></H1>
        <NoticeBar
            color={ALERT_YELLOW}
        ...
        <form onSubmit={(e) => {
          e.preventDefault();
            ...
            <input
              ...
              onChange={() => this.setState({ isTermsOfService: !this.state.isTermsOfService })}
            />
            ...
            <input
              ...
              onChange={() => this.setState({ isPrivacyPolicy: !this.state.isPrivacyPolicy })}
            />

  ...
  render() {
    return (
      ...
      >
        ...
        <Section>
          <H2>0. <IntlText intlKey='common.schedule'>개인정보 처리 방침이란?</IntlText></H2>
        ...
        <Section>
          <H2>1. <IntlText intlKey='common.schedule'>개인정보 수집 항목과 목적</IntlText></H2>
          <Ol>
        ...
        <Section>
          <H2>2. <IntlText intlKey='common.schedule'>개인정보 자동 수집 - 쿠키</IntlText></H2>
          <Paragraph><IntlText intlKey='asdfasdfasdf'>
        ...
        <Section>
          <H2>3. <IntlText intlKey='common.schedule'>개인정보의 안전성 확보 조치</IntlText></H2>
          <Ol>
            <Li><IntlText intlKey='common.schedule'>
        ...
        <Section>
          <H2>4. <IntlText intlKey='common.schedule'>개인정보의 파기</IntlText></H2>
          <Paragraph><IntlText intlKey='asdfasdfasdf'>
        ...
        <Section>
          <H2>5. <IntlText intlKey='common.schedule'> 개인정보 보호 책임자</IntlText></H2>
          <Paragraph><IntlText intlKey='asdfasdfasdf'>
        ...
        <Section>
          <H2>6. <IntlText intlKey='common.schedule'>개인정보 처리방침 변경</IntlText></H2>
          <Paragraph><IntlText intlKey='asdfasdfasdf'>

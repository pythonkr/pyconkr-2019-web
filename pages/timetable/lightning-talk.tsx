...
@inject('stores')
@observer
class LightningTalk extends React.Component<PageDefaultPropsType> {
  ...
  render() {
    const { t } = this.props
    const _title = t('timetable:lightningTalk.title')
...
export default  withNamespaces(['timetable'])(LightningTalk)

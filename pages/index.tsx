    ...
    return (
      <>
        ...
        <ScheduleSection>
          <ul>
            <li>
              <h2><IntlText intlKey='constant.pyconKorea.sprint.name'>스프린트</IntlText></h2>
              <h3><IntlText intlKey='constant.pyconKorea.sprint.schedule'>8월 15-16일</IntlText></h3>
              <span><IntlText intlKey='constant.pyconKorea.sprint.dayofweek'>목-금</IntlText></span>
              <hr />
              <p><IntlText intlKey='home.sprintDescription'>
                관심있는 오픈소스 프로젝트를 같은 장소에 모여 집중적으로 배우고 개발하는 자리입니다.
                새로운 동료를 만나고, 오픈소스에서 얻을 수 있는 경험과 지식을 나눌 수 있습니다.
              </IntlText></p>
            </li>
            <li>
              <h2><IntlText intlKey='constant.pyconKorea.tutorial.name'>튜토리얼</IntlText></h2>
              <h3><IntlText intlKey='constant.pyconKorea.tutorial.schedule'>8월 16일</IntlText></h3>
              <span><IntlText intlKey='constant.pyconKorea.tutorial.dayofweek'>금</IntlText></span>
              <hr />
              <p><IntlText intlKey='home.tutorialDescription'>
                초보자들을 위해, 또는 새로운 것을 접하는 사람들을 위해 진행하는
                교육 프로그램입니다.
              </IntlText></p>
            </li>
            <li>
              <h2><IntlText intlKey='constant.pyconKorea.conference.name'>컨퍼런스</IntlText></h2>
              <h3><IntlText intlKey='constant.pyconKorea.conference.schedule'>8월 17-18일</IntlText></h3>
              <span><IntlText intlKey='constant.pyconKorea.conference.dayofweek'>토-일</IntlText></span>
              <hr />
              <p>
        ...
        <SponserSection>
          <ContentWidthWrapper>
            ...
            <p><IntlText intlKey='home.sponsor.description2'>
        ...
        <IntroduceSection>
          <ContentWidthWrapper>
            <h2><IntlText intlKey='home.pyconKoreaTitle'>파이콘 한국이란</IntlText></h2>
            <p><IntlText intlKey='home.pyconKoreaDescription'>
            ...
            <p><IntlText intlKey='home.sloganDescription1'>
              파이콘 한국 2019의 슬로건은 "Connect the Pythonistas"입니다.
              </IntlText></p>
            <p><IntlText intlKey='home.sloganDescription2'>
            ...
            <p><IntlText intlKey='home.sloganDescription3'>
              우리는 파이콘을 통해, 방향과 분야가 숱하게 흩어져 각기 다른 점으로 존재하는 파이써니스타들이 모여
              아름다운 별자리가 되기를 바랍니다. 2019년에도 우리, 파이콘에서 만나요.
              </IntlText></p>
            <hr />
            <h2><IntlText intlKey='home.differenceWithOthers.title'>
              파이콘은 다른 개발자 행사와 무엇이 다른가요?
            </IntlText></h2>
            <p><IntlText intlKey='home.differenceWithOthers.description'>
